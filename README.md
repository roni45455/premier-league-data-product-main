...
## Please note that there were more code-editing with the copilot extention via VS code so the code generated by the models was modified sevrel times - I could not export the transcript from the extention
